...
namespace ProjectArchitecture.Domain.Tests
{
    public class ProductUnitTest
    {
        ...
        {
            Action action = () => new Product(1, "Product Name", "Product Description", 850.40m, 76, "Product Image");
            action.Should()
        ...
        {
            Action action = () => new Product(1, "P", "Product Description", 850.40m, 76, "Product Image");
            action.Should()
                .Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Product name", "Product Description", -850.40m, 76, "Product Description");
            action.Should()
                .Throw<DomainExceptionValidation>()
